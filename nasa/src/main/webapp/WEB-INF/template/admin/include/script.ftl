...
<script src="${base}/resources/js/plugins/prettyfile/bootstrap-prettyfile.js"></script>
 ...
 <!--kindeditor-->
<script type="text/javascript" src="${base}/resources/plugins/editor/kindeditor.js"></script>
...
<script type="text/javascript" src="${base}/resources/js/admin/list.js"></script>  
<script type="text/javascript" src="${base}/resources/js/admin/jquery.lSelect.js"></script>  
