                       			 	...
                       			 	<label class="col-sm-2 control-label">资源菜单</label>
                       			 	 <div class="col-sm-10">
		                                    ...
		                                    <div class="checkbox-inline i-checks">
		                                       <input type="checkbox" class="i-checks" name="ids" value="${root.id}">${root.name}
		                                    </div>
		                                    <br>
		                                    [#list root.children as child]
		                                    	<div class="checkbox-inline i-checks"style="margin-left:30px;">
			                                       <input type="checkbox" class="i-checks" name="ids" value="${child.id}">${child.name}
			                                    </div>
			                                    <br>
                         ...
                         <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                    ...
	                                    <div class="checkbox-inline i-checks">
	                                       <input type="checkbox" class="i-checks" name="isSystem" value="true">
	                                    </div>
	                                </div>
