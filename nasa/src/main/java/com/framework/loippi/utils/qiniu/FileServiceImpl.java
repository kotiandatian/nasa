...
public class FileServiceImpl implements FileService {
	...
	public static final String QINIU_TOKEN = "catchdoll";
	
	public static final String QINIU_AK = "SM6eyezsftPFbb86uL1FSMloWe3dwJLi1E08TNOY";
	
	public static final String QINIU_SK = "QYmZZfYWKvavnu1BJPCHWbrEwoFX8s8u6JB7AFnd";
	
	public static final String QINIU_PREFIX = "http://p00658t9u.bkt.clouddn.com/";
	/**
	 * 文件类型
	 */
...
//    String token = auth.uploadToken(QINIU_TOKEN);
	...
	public  String upload(String url) {
		try {
				...
				uploadManager.put(url, filename , auth.uploadToken(QINIU_TOKEN));
		       return QINIU_PREFIX.concat(filename);
		} catch (QiniuException e) {
			 Response r = e.response;
		        // 请求失败时简单状态信息
